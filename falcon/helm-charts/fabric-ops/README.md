...
| `ca_endpoint` | FQDN of the CA server endpoint with port. `Eg; ica-second-peer.my-hlf-domain.com:30000` | `""` |
...
anchor_peers:
   - host: peer0-first-peer.my-hlf-domain.com
     port: "30000"
   - host: peer1-first-peer.my-hlf-domain.com
     port: "30000"
   - host: peer2-first-peer.my-hlf-domain.com
     port: "30000"
```
...
| `ica_endpoint` | FQDN of the MSPCA server endpoint with port | `"ica-first-peer.my-hlf-domain.com:30000"` |
| `tlsca_endpoint` | FQDN of the TLSCA server endpoint with port | `"tls-ca.my-hlf-domain.com:30000"` |
| `orderer_endpoint` | FQDN of the Orderer node endpoint with port | `"orderer0-orderer.my-hlf-domain.com:30000"` |
| `hlf_channel` | The channel to update | `""` |
| `admin_identity` | Any valid Admin user identity array in `ica_endpoint`. [Refer](#Admin-identity) | `[]` |
...
| `core_peer_address` | Core peer address | `"peer0-first-peer:30002"` |
